...
usage: plat.pl --out=PREFIX_FOR_OUTFILES --k=KMER --m=MEMORY_LIMIT --left=LEFT_FASTQ --right=RIGHT_FASTQ --unp=UNPAIRED_FASTQ [--threads=NUMTHREADS] [--version] [--help]

=head1 DESCRIPTION

script to run the following: (1) platanus assemble, (2) platanus scaffold, and (3) platanus gap_close.
